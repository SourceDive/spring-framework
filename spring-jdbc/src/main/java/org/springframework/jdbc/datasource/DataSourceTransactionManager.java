...
public class DataSourceTransactionManager extends AbstractPlatformTransactionManager
	...
	/**
	 * <p>
	 * <ul>1、解绑 connection holder</ul>
	 * <ul>2、重置connection属性</ul>
	 * <ul>3、真正释放连接</ul>
	 * <ul>4、重置 transaction object 属性</ul>
	 * </p>
	 */
	@Override
